...
class MyCli(object):
    ...
    def __init__(self, sqlexecute=None, prompt=None,
        ...
        if c.filename not in self.system_config_files:
            write_default_config(self.default_config_file, user_config_file)
...
@click.option('--user-config-file', type=click.Path(), default="~/.myclirc",
              help='Only read user config file from the given file')
